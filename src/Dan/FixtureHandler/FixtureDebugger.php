...
class FixtureDebugger
{
    ...
    public function checkDetectedDependencies($hash, FixtureInterface $fixture)
    {
    ...
    public function declareLoadFixtureFailed(\Throwable $e, $notLoadedFixtures, $availableRefs)
    {
    ...
    public function declareUnresolvable($notLoadedFixtures, $availableRefs)
    {
        $notLoadedFixtures = new NotLoadedFixtureReports(array_values($notLoadedFixtures), array_keys($availableRefs));
        throw new UnresolvableDependenciesException($this->loadedFixtures(), $notLoadedFixtures);
    }
    protected function loadedFixtures()
    {
        $items = [];
